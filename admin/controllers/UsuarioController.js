...
export default {
    ...
    update: async (req,res,next) => {
        try {
            ...
            //si el pass que recibo porel front el diferente al de la bd no lo encripto de nuevo
    ...
    login: async (req,res,next) => {
        try {
            //consulto el email que recibo y valido si existe
            let user = await models.Usuario.findOne({email:req.body.email,estado:1});
            if (user){
                //verifico con el metodo compare de bycrypt los 2 pass
